    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="lg:hidden">
          ...
          {/* Imagen mobile */}
          {/* Card unificada mobile: imagen + contenido */}
          <div
          ...
          >
            <div className="overflow-hidden rounded-[1.8rem] border border-[#8D1E29]/10 bg-[#FFF7EC]/45 shadow-[0_20px_55px_rgba(47,31,20,0.18)] backdrop-blur-sm">
              {/* Imagen */}
              <div className="group relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#14100D]/35 via-transparent to-transparent" />
              </div>
            ...
            <img
              ...
              alt=""
              className={`pointer-events-none absolute -right-3 -top-7 z-20 w-28 drop-shadow-[0_14px_24px_rgba(47,31,20,0.28)] transition-all delay-500 duration-700 ease-out ${
                isVisible
